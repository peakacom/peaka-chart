...
-- Name: abstract_schema_mapper; Type: SCHEMA; Schema: -; Owner: {{ include "peaka.postgresql.user" . }}
--

CREATE SCHEMA abstract_schema_mapper;


ALTER SCHEMA abstract_schema_mapper OWNER TO {{ include "peaka.postgresql.user" . }} ;

--
-- TOC entry 2465 (class 1255 OID 16688)
-- Name: clone_schema(bigint, text, text, text, text, text, text, boolean, text[], text[]); Type: FUNCTION; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER FUNCTION abstract_schema_mapper.clone_schema(app_id bigint, app_name text, app_display_name text, source_schema text, dest_schema text, source_external_schema_name text, dest_external_schema_name text, include_recs boolean, tables_to_data_copy text[], replaced_catalog_names text[]) OWNER TO {{ include "peaka.postgresql.user" . }} ;

--
-- TOC entry 2270 (class 1255 OID 16691)
-- Name: create_column(text, text, text[], jsonb, integer); Type: FUNCTION; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER FUNCTION abstract_schema_mapper.create_column(schema_name text, table_name text, execute_statements text[], column_props jsonb, order_input integer) OWNER TO {{ include "peaka.postgresql.user" . }} ;

--
-- TOC entry 2271 (class 1255 OID 16692)
-- Name: create_column_props_with_id_corrected(text, text, jsonb); Type: FUNCTION; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER FUNCTION abstract_schema_mapper.create_column_props_with_id_corrected(schema_name text, table_name text, params jsonb) OWNER TO {{ include "peaka.postgresql.user" . }} ;

--
-- TOC entry 2272 (class 1255 OID 16693)
-- Name: create_table(text, text, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb); Type: FUNCTION; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER FUNCTION abstract_schema_mapper.create_table(schema_name text, table_name text, id_params jsonb, version_params jsonb, created_time_params jsonb, created_by_params jsonb, last_modified_time_params jsonb, last_modified_by_params jsonb, session_params jsonb, first_col_params jsonb) OWNER TO {{ include "peaka.postgresql.user" . }} ;

--
-- TOC entry 2273 (class 1255 OID 16694)
-- Name: delete_column(text, text, text); Type: FUNCTION; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER FUNCTION abstract_schema_mapper.delete_column(schema_name text, table_name text, column_name text) OWNER TO {{ include "peaka.postgresql.user" . }} ;

--
-- TOC entry 2274 (class 1255 OID 16695)
-- Name: delete_table(text, text); Type: FUNCTION; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER FUNCTION abstract_schema_mapper.delete_table(schema_name text, table_name text) OWNER TO {{ include "peaka.postgresql.user" . }} ;

--
-- TOC entry 2275 (class 1255 OID 16696)
-- Name: execute_statements_sequentially(text[]); Type: FUNCTION; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER FUNCTION abstract_schema_mapper.execute_statements_sequentially(execute_statements text[]) OWNER TO {{ include "peaka.postgresql.user" . }} ;

--
-- TOC entry 2276 (class 1255 OID 16697)
-- Name: insert_update_trigger(); Type: FUNCTION; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER FUNCTION abstract_schema_mapper.insert_update_trigger() OWNER TO {{ include "peaka.postgresql.user" . }} ;

--
-- TOC entry 2277 (class 1255 OID 16698)
-- Name: next_id(); Type: FUNCTION; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER FUNCTION abstract_schema_mapper.next_id(OUT result bigint) OWNER TO {{ include "peaka.postgresql.user" . }} ;

--
-- TOC entry 2278 (class 1255 OID 16699)
-- Name: replace_recursive(text, text[]); Type: FUNCTION; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER FUNCTION abstract_schema_mapper.replace_recursive(search text, from_to text[]) OWNER TO {{ include "peaka.postgresql.user" . }} ;

--
-- TOC entry 2279 (class 1255 OID 16700)
-- Name: update_table_name(text, text, text); Type: FUNCTION; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER FUNCTION abstract_schema_mapper.update_table_name(schema_name text, table_old_name text, table_new_name text) OWNER TO {{ include "peaka.postgresql.user" . }} ;
...
-- Name: abstract_identity; Type: TABLE; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER TABLE abstract_schema_mapper.abstract_identity OWNER TO {{ include "peaka.postgresql.user" . }} ;

--
-- TOC entry 580 (class 1259 OID 16895)
-- Name: abstract_row; Type: TABLE; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER TABLE abstract_schema_mapper.abstract_row OWNER TO {{ include "peaka.postgresql.user" . }} ;

--
-- TOC entry 581 (class 1259 OID 16905)
-- Name: sm_app; Type: TABLE; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER TABLE abstract_schema_mapper.sm_app OWNER TO {{ include "peaka.postgresql.user" . }} ;
...
ALTER TABLE IF EXISTS abstract_schema_mapper.sm_query_share
    OWNER to {{ include "peaka.postgresql.user" . }} ;
...
-- Name: sm_cat_share; Type: TABLE; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER TABLE abstract_schema_mapper.sm_cat_share OWNER TO {{ include "peaka.postgresql.user" . }} ;

--
-- TOC entry 583 (class 1259 OID 16927)
-- Name: table_id_seq; Type: SEQUENCE; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
ALTER TABLE abstract_schema_mapper.table_id_seq OWNER TO {{ include "peaka.postgresql.user" . }} ;

--
-- TOC entry 8828 (class 2604 OID 29615)
-- Name: sm_app _id; Type: DEFAULT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_app _version; Type: DEFAULT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_app _created_time; Type: DEFAULT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_app _created_by; Type: DEFAULT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_app _last_modified_time; Type: DEFAULT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_app _last_modified_by; Type: DEFAULT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_cat_share _id; Type: DEFAULT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_cat_share _version; Type: DEFAULT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_cat_share _created_time; Type: DEFAULT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_cat_share _created_by; Type: DEFAULT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_cat_share _last_modified_time; Type: DEFAULT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_cat_share _last_modified_by; Type: DEFAULT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_cat_share _session; Type: DEFAULT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Dependencies: 579
-- Data for Name: abstract_identity; Type: TABLE DATA; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Dependencies: 580
-- Data for Name: abstract_row; Type: TABLE DATA; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Dependencies: 581
-- Data for Name: sm_app; Type: TABLE DATA; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--

--
-- TOC entry 9009 (class 0 OID 0)
-- Dependencies: 583
-- Name: table_id_seq; Type: SEQUENCE SET; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: abstract_identity abstract_identity_pkey; Type: CONSTRAINT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: abstract_row abstract_row_pkey; Type: CONSTRAINT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_app sm_app_pkey; Type: CONSTRAINT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_cat_share sm_cat_share_pkey; Type: CONSTRAINT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_app sm_app_insert_update_trigger; Type: TRIGGER; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_cat_share _dst_app_id_fk; Type: FK CONSTRAINT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
...
-- Name: sm_cat_share _src_app_id_fk; Type: FK CONSTRAINT; Schema: abstract_schema_mapper; Owner: {{ include "peaka.postgresql.user" . }}
--
